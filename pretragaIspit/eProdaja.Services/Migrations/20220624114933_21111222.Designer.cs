...
namespace eProdaja.Services.Migrations
{
    ...
    [Migration("20220624114933_21111222")]
    partial class _21111222
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eProdaja.Services.Database.PretragaIspit", b =>
                {
                    b.Property<int>("PretragaIspitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PretragaIspitId"), 1L, 1);
                    ...
                    b.Property<double>("iznosPrometa")
                        .HasColumnType("float");

                    b.Property<double>("minIznosPrometa")
                        .HasColumnType("float");
                    ...
                    b.HasKey("PretragaIspitId");

                    b.HasIndex("KorisnikId");

                    b.HasIndex("VrstaProizvodaId");

                    b.ToTable("PretragaIspit");
                });
            ...
            modelBuilder.Entity("eProdaja.Services.Database.PretragaIspit", b =>
                {
                    b.HasOne("eProdaja.Services.Database.Korisnici", "korisnik")
                        .WithMany("PretragaIspiti")
                        .HasForeignKey("KorisnikId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eProdaja.Services.Database.VrsteProizvodum", "vrstaProizvoda")
                        .WithMany("PretragaIspiti")
